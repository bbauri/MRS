...
public class DriverScript_2 extends FrameworkScript {
	...
	public void execute(String tcname, String setpname,String action,String properties, String data) {
		...
		//FineElement
		we = findElement(properties);
		
		//Action
		executeAction(we, action, data);
		}
	...
	public void executeAction(WebElement we,String action, String data) {
